...
public static final String TABLE_NAME="passengers";
    ...
    public static final String COLUMN_PASSNUMBER="passNumber";
...
private  static final String DATABASE_CREATE=" CREATE TABLE "
        ...
        Cursor cursor = db.query(
            ...
            if (cursor.moveToFirst()) {
                ...
                final Passenger objPassenger = new Passenger.PassengerBuilder()
                        .passNumber(cursor.getLong(cursor.getColumnIndex(COLUMN_PASSNUMBER)))
                        .id(cursor.getString(cursor.getColumnIndex(COLUMN_IDNUM)))
    ...
    public Passenger add(Passenger entity) {
        ...
        values.put(COLUMN_PASSNUMBER,entity.getPassNumber());
        values.put(COLUMN_IDNUM,entity.getIdNumber());
    ...
    public Passenger update(Passenger entity) {
        ...
        db.update(TABLE_NAME,values,COLUMN_PASSNUMBER + " =? ", new String[]{String.valueOf(entity.getPassNumber())});
    ...
    public Passenger remove(Passenger entity) {
        ...
        db.delete(TABLE_NAME,
                COLUMN_PASSNUMBER +" =? ", new String[]{String.valueOf(entity.getPassNumber())});
        return entity;
    }
